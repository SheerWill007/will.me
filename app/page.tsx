        ...
        <section className="space-y-5">
          <div>
            ...
            <p className="text-sm text-foreground/70 mt-1">
              <Typewriter prefix="21, " words={[ "design engineer." , "gamer." , "tech nerd." , ]} />
            </p>
          </div>
          ...
          <div className="space-y-5 text-[14px] leading-7 text-foreground/90">
            ...
            <p>
              You’ll find me posting random thoughts on{" "}
              ...
              , building weird projects, and occasionally shipping something useful.
            </p>
            href="mailto:williambenjaminlaw007@gmail.com"
            className="relative text-foreground after:absolute after:left-0 after:bottom-0 after:h-[1px] after:w-0
      ...
      <Reveal>
        <section className="space-y-6">
          ...
          <div className="relative space-y-8 border-l border-white/80 pl-7">
            ...
            <Experience title="Hack Tour IND Cohort" date="2025"
              desc="Actively participated in high-profile web3 events including Polkadot, Ethereum and Solana Cyberpunk." />

            <Experience title="Student Coordinator — PU Hackathon" date="2025"
              desc="Facilitated workshops and interactive sessions for students." />

            <Experience title="Smart India Hackathon" date="2025" link="https://github.com/yourusername/sih-project"
              desc="Selected for the second round and shortlisted for the final round among top teams." />

            <Experience title="Oodo Hackathon" date="2025" link="https://github.com/yourusername/oodo-project"
      ...
      <Reveal>
        <section className="space-y-6">
          ...
          <div>
            ...
            <a href="https://www.credly.com/users/will.me" target="_blank" rel="noopener noreferrer"
          ...
          <div className="relative space-y-8 border-l border-white/80 pl-7">
            ...
            <Certification title="Hashgraph Developer Course" org="Hashgraph" date="Dec 2025"
              desc="Built decentralized applications on the Hashgraph distributed ledger." />

            <Certification title="Data Science Essentials with Python" org="Cisco Networking Academy" date="Oct 2025"
              desc="Used Pandas for data manipulation and Matplotlib for visualization." />

            <Certification title="Artificial Intelligence Fundamentals" org="IBM SkillsBuild" date="Sep 2025"
              desc="Studied machine learning, NLP and neural networks." />

            <Certification title="AWS Academy Cloud Foundations" org="AWS Academy" date="Aug 2025"
      ...
      <Reveal>
        <section className="space-y-5 border-t border-white/10 pt-10 mt-10">
          ...
          <div className="flex justify-between w-full text-sm text-foreground/70 tracking-wide pt-4">
            ...
            <a href="https://github.com/sheerwill007" target="_blank" rel="noopener noreferrer"
              className="hover:text-foreground transition">
              GitHub
            </a>

            <a href="https://leetcode.com/u/SheerWill007" target="_blank" rel="noopener noreferrer"
              className="hover:text-foreground transition">
              LeetCode
            </a>
            ...
            <a href="mailto:williambenjaminlaw007@gmail.com" className="hover:text-foreground transition">
              Gmail
            </a>

            <a href="mailto:WilliamTecumsehSherman007@proton.me" className="hover:text-foreground transition">
              Proton
            </a>
